  ...
  BUI.augment(mainPage,{
    ...
    _createModule:function(id){
      ...
      module = new tabNav(id,
    		  {render:tabId,height:getAutoHeight() - 5},
    		  {render:treeId,items:item.menu,height:getAutoHeight() - 5,
    			  //修改模版 chenxw
    		   itemTpl:'<div class="'+CLS_MENU_TITLE+'"><i class="iconfont menu-icon {icon}"></i><span class="'+CLS_MENU_TITLE+'-text">{text}</span></div>'
