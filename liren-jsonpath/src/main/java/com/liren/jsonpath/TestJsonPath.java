...
/**
 * @author QiaoJiafei
 * @version 创建时间：2016年3月2日 下午3:37:42 类说明
 */
public class TestJsonPath {
	...
	public static void main(String[] args) {
		...
		// String sjson = "{\"store\": {\"book\": [{\"category\":
		// \"reference\",\"author\": \"Nigel Rees\",\"title\": \"Sayings of the
		// Century\",\"price\": 8.95},{\"category\": \"fiction\",\"author\":
		// \"Evelyn Waugh\",\"title\": \"Sword of Honour\",\"price\":
		// 12.99},{\"category\": \"fiction\",\"author\": \"Herman
		// Melville\",\"title\": \"Moby Dick\",\"isbn\":
		// \"0-553-21311-3\",\"price\": 8.99},{\"category\":
		// \"fiction\",\"author\": \"J. R. R. Tolkien\",\"title\": \"The Lord of
		// the Rings\",\"isbn\": \"0-395-19395-8\",\"price\":
		// 22.99}],\"bicycle\": {\"color\": \"red\",\"price\":
		// 19.95}},\"expensive\": 10}";
		/*
		 * print(
		 * "--------------------------------------getJsonValue0--------------------------------------"
		 * ); getJsonValue0(sjson); print(
		 * "--------------------------------------getJsonValue1--------------------------------------"
		 * ); getJsonValue1(sjson); print(
		 * "--------------------------------------getJsonValue2--------------------------------------"
		 * ); getJsonValue2(sjson); print(
		 * "--------------------------------------getJsonValue3--------------------------------------"
		 * ); getJsonValue3(sjson); print(
		 * "--------------------------------------getJsonValue4--------------------------------------"
		 * ); getJsonValue4(sjson);
		 */
	...
	private static String readtxt() {
		...
		try {
			FileReader fr = new FileReader("D:/GitRepository/temp/study-demo/liren-jsonpath/src/main/resources/json.txt");
...
//		List<Object> read = JsonPath.read(authors3, "$.book[*].author");
