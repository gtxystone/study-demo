...
//        new Disruptor<TradeTransaction>(new EventFactory<TradeTransaction>() {  
//            @Override  
//            public TradeTransaction newInstance() {  
//                return new TradeTransaction();  
//            }  
//        }, bufferSize, newSingleThreadExecutor, ProducerType.SINGLE, new BusySpinWaitStrategy());
