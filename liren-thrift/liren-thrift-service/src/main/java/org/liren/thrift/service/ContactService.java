...
public class ContactService {
  ...
  public interface Iface {
    ...
    public java.util.List<Contact> getAll() throws org.apache.thrift.TException;

    public java.util.List<Contact> query(java.util.Map<java.lang.String,java.lang.String> conditions) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void save(Contact contact, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws org.apache.thrift.TException;
    ...
    public void getAll(org.apache.thrift.async.AsyncMethodCallback<java.util.List<Contact>> resultHandler) throws org.apache.thrift.TException;

    public void query(java.util.Map<java.lang.String,java.lang.String> conditions, org.apache.thrift.async.AsyncMethodCallback<java.util.List<Contact>> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_save(Contact contact) throws org.apache.thrift.TException
    {
    ...
    public java.util.List<Contact> recv_getAll() throws org.apache.thrift.TException
    {
    ...
    public void send_query(java.util.Map<java.lang.String,java.lang.String> conditions) throws org.apache.thrift.TException
    {
    ...
    public java.util.List<Contact> recv_query() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class save_call extends org.apache.thrift.async.TAsyncMethodCall<Void> {
      ...
      public save_call(Contact contact, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
    ...
    public static class getAll_call extends org.apache.thrift.async.TAsyncMethodCall<java.util.List<Contact>> {
      public getAll_call(org.apache.thrift.async.AsyncMethodCallback<java.util.List<Contact>> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
      }
      ...
      public java.util.List<Contact> getResult() throws org.apache.thrift.TException {
        if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
          throw new java.lang.IllegalStateException("Method call not finished!");
        }
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
    ...
    public static class query_call extends org.apache.thrift.async.TAsyncMethodCall<java.util.List<Contact>> {
      private java.util.Map<java.lang.String,java.lang.String> conditions;
      public query_call(java.util.Map<java.lang.String,java.lang.String> conditions, org.apache.thrift.async.AsyncMethodCallback<java.util.List<Contact>> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class getAll<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getAll_args, java.util.List<Contact>> {
      public getAll() {
        super("getAll");
      }
      ...
      public void start(I iface, getAll_args args, org.apache.thrift.async.AsyncMethodCallback<java.util.List<Contact>> resultHandler) throws org.apache.thrift.TException {
        iface.getAll(resultHandler);
      }
    }

    public static class query<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, query_args, java.util.List<Contact>> {
      public query() {
        super("query");
      }
      ...
      public void start(I iface, query_args args, org.apache.thrift.async.AsyncMethodCallback<java.util.List<Contact>> resultHandler) throws org.apache.thrift.TException {
...
;
  ...
  public static class getAll_result implements org.apache.thrift.TBase<getAll_result, getAll_result._Fields>, java.io.Serializable, Cloneable, Comparable<getAll_result>   {
    ...
    public getAll_result setSuccess(java.util.List<Contact> success) {
      this.success = success;
      return this;
    }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new java.util.ArrayList<Contact>(_list10.size);
                  Contact _elem11;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, getAll_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (Contact _iter13 : struct.success)
            {
              _iter13.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (Contact _iter14 : struct.success)
            {
              _iter14.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new java.util.ArrayList<Contact>(_list15.size);
            Contact _elem16;
  ...
  public static class query_args implements org.apache.thrift.TBase<query_args, query_args._Fields>, java.io.Serializable, Cloneable, Comparable<query_args>   {
    ...
    public java.util.Map<java.lang.String,java.lang.String> conditions; // required
    ...
    public query_args setConditions(java.util.Map<java.lang.String,java.lang.String> conditions) {
      this.conditions = conditions;
      return this;
    }
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
                {
                  ...
                  struct.conditions = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map18.size);
                  ...
                  for (int _i21 = 0; _i21 < _map18.size; ++_i21)
                  {
                    ...
                    struct.conditions.put(_key19, _val20);
                  }
                  iprot.readMapEnd();
                }
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, query_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.conditions != null) {
          oprot.writeFieldBegin(CONDITIONS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter22 : struct.conditions.entrySet())
            {
        ...
        if (struct.isSetConditions()) {
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.String> _iter23 : struct.conditions.entrySet())
            {
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.conditions = new java.util.HashMap<java.lang.String,java.lang.String>(2*_map24.size);
            ...
            for (int _i27 = 0; _i27 < _map24.size; ++_i27)
            {
              ...
              struct.conditions.put(_key25, _val26);
            }
          }
          struct.setConditionsIsSet(true);
        }
  ...
  public static class query_result implements org.apache.thrift.TBase<query_result, query_result._Fields>, java.io.Serializable, Cloneable, Comparable<query_result>   {
    ...
    public query_result setSuccess(java.util.List<Contact> success) {
      this.success = success;
      return this;
    }
    ...
    private static class query_resultStandardScheme extends org.apache.thrift.scheme.StandardScheme<query_result> {
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new java.util.ArrayList<Contact>(_list28.size);
                  Contact _elem29;
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, query_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          ...
          {
            oprot.writeListBegin(new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.STRUCT, struct.success.size()));
            for (Contact _iter31 : struct.success)
            {
              _iter31.write(oprot);
            }
            oprot.writeListEnd();
    ...
    private static class query_resultTupleScheme extends org.apache.thrift.scheme.TupleScheme<query_result> {
      ...
      public void write(org.apache.thrift.protocol.TProtocol prot, query_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.isSetSuccess()) {
          {
            oprot.writeI32(struct.success.size());
            for (Contact _iter32 : struct.success)
            {
              _iter32.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new java.util.ArrayList<Contact>(_list33.size);
            Contact _elem34;
